...
class AirSimEnv(gym.Env):
    ...
    def __init__(self):
        ...
        self.observation_space = spaces.Box(low=0, high=255, shape=(9,))
        self.state = {}

        self.action_space = spaces.Box(low=0, high=255, shape=(4,))
        ...
        global airgym
        airgym = airsim.MultirotorClient()
    ...
    def _step(self, action):
        ...
        self.stepN += 1
        # roll = action[0], yaw = action[1], throttle = action[2], pitch = action[3]
        airgym.moveByRC(rcdata = airsim.RCData(*action, is_initialized=True, is_valid=True))
